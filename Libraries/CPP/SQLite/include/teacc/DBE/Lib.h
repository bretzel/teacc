...
#   ifdef DBE_DLL_EXPORT
#       define DBE_LIB __declspec(dllexport)
#       if __GNUC__ >= 4
#           define DBE_LIB __attribute__ ((visibility ("default")))
...
#       endif
#   else
#       define DBE_LIB __declspec(dllimport)
#   endif
#   else
#       define DBE_LIB    // Not ms-Windows/MSVC
#endif
